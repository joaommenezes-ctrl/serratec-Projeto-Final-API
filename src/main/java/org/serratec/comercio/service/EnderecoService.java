...
import org.serratec.comercio.dto.EnderecoDTO;
import org.serratec.comercio.repository.EnderecoRepository;
...
public class EnderecoService {
	...
	public EnderecoDTO buscar(String cep) {
		...
		if (enderecoOpt.isPresent()) {
			...
			Optional<Endereco> enderecoViaCepOpt = 
					Optional.ofNullable(restTemplate.getForObject(url, Endereco.class));
